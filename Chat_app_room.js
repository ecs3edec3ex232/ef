...
firebase.initializeApp(firebaseConfig);
  ...
  row="<div id="+Room_names+"class='room_name onclick='redirectToRoomName(this.id)'>#"+Room_name+"</div> <hr>";
  ...
  function addRoom(){
    ...
    firebase.database().ref("/").child(room_name).update({
      purpose:"adding room name"
         ...
         localStorage.setItem("rom_name",room_name);
  ...
  function logout(){
    ...
    localStorage.location = "index.html";
  }